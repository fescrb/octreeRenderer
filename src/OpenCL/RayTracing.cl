...
int push(stack* short_stack, int curr_index, global char* curr_address, float3 corner_far, float3 voxelCentre, float t_min, float t_max) {
...
__kernel void ray_trace(global char* octree,
